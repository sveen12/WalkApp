...
require 'controladores/routes.php';
require 'controladores/points.php';
require 'controladores/ratings.php';
require 'controladores/favorites.php';
require 'controladores/uploads.php';
...
$recursos_existentes = array('users','routes',"points","ratings","favorites","uploads");
